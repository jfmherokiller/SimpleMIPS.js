import {Lib} from "./Lib";
import regexline = Instructiondefinitions.regexline;
import PsudoInstruction = Instructiondefinitions.PsudoInstruction;


namespace Instructiondefinitions {

    import TOKEN_TYPES = tokenizer.TOKEN_TYPES;

    export interface regexline {
        n: string;
        r: RegExp;
    }
...
class PiObject {
    ...
    constructor() {
        let CPUInstClasses = Instructions.MakeCPUInstructionClasses();
        this.makePitable();
        ...
        this.SHARED_INST = Lib.overlap(this.PI_NAMES, CPUInstClasses.INST_ALL);
    }
